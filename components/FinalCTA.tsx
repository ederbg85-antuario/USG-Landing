  ...
  return (
    <section className="relative overflow-hidden bg-black">
      ...
      <div className="relative w-full">
        <div className="relative aspect-[16/9] sm:aspect-[16/8] lg:aspect-[16/7] w-full overflow-hidden">
          <Image
          ...
          <div className="absolute inset-0 flex items-center justify-center px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl">
              <div className="inline-flex items-center gap-2 bg-white/10 border border-white/30 backdrop-blur-md rounded-full px-5 py-2 mb-6">
                <span className="w-2 h-2 bg-usg-red rounded-full animate-pulse" />
                <span className="text-xs sm:text-sm font-semibold text-white tracking-widest uppercase">
                  ÚLTIMO LLAMADO A LA CANCHA
                </span>
              </div>
              <h2 className="font-display text-white tracking-tight leading-[0.88] text-5xl sm:text-7xl md:text-8xl lg:text-[7rem] drop-shadow-2xl">
                ¡La mejor selección
          ...
          {/* Banda perimetral USG */}
          <div className="absolute bottom-0 left-0 right-0 h-7 usg-board" />
        </div>
      </div>
      ...
      <div className="relative bg-gradient-to-br from-usg-red via-usg-red-dark to-black overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            {/* Tarjeta blanca con el logo USG (vector) */}
            <div className="inline-flex items-center justify-center bg-white rounded-2xl px-8 py-5 shadow-2xl shadow-black/60 mb-8">
              <UsgLogo
                variant="dark"
            ...
            <p className="text-xl sm:text-2xl text-white font-semibold mb-4 leading-snug max-w-2xl mx-auto">
              No necesitas registrar correo ni descargar nada.
            </p>
            <p className="text-base sm:text-lg text-white/85 mb-10 leading-relaxed max-w-2xl mx-auto">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-white text-usg-red font-bold px-10 py-5 rounded-full text-lg sm:text-xl shadow-2xl hover:scale-105 transition-transform"
            >
              <svg
            ...
            <p className="text-sm text-white/75 mt-7">
